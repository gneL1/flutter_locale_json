...
import 'package:flutter_locale_json/cli/constants.dart';
...
class FlutterLocaleLoader{
  ...
  static Future<Map<String, Map<String, String>>> loadLocalesFromAssets() async {
    ...
    /// 2. 获取目录地址
    final configData = await rootBundle.loadString(configFile);
    final map = loadYaml(configData) as YamlMap;
    final jsonDir = map[translationKey]?.toString() ?? defaultTranslationsDir;
